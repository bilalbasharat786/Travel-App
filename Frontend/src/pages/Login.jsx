    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white relative overflow-hidden font-sans px-4">
      ...
      <div className="max-w-md w-full bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-gray-100 z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-[#181E4B] text-3xl font-bold font-serif">Welcome Back</h2>
          <p className="text-gray-500 mt-2">Login to explore the best destinations</p>
        </div>

        <form className="space-y-6">
          <div>
            <label className="block text-[#181E4B] font-medium mb-2">Email Address</label>
            <input 
              type="email" 
          ...
          <div>
            <div className="flex justify-between mb-2">
              ...
              <a href="#" className="text-[#DF6951] text-sm hover:underline">Forgot?</a>
            </div>
            <input 
              type="password" 
              placeholder="••••••••"
        ...
        <p className="text-center mt-8 text-gray-600">
          ...
          <a href="/signup" className="text-[#DF6951] font-bold ml-2 hover:underline">Sign up</a>
        </p>
      </div>
    </div>
  );
