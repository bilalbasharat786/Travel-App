      ...
      <div className="max-w-md w-full bg-white/90 backdrop-blur-xl p-6 sm:p-8 md:p-10 rounded-[30px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 z-10 relative">
        <div className="text-center mb-8 md:mb-10">
          <img
            src={Logo}
            alt="Jadoo"
            className="h-8 md:h-10 mx-auto mb-4 md:mb-6"
          />
        ...
        <form className="space-y-5 md:space-y-6">
          ...
          <div>
            <div className="flex justify-between mb-2">
              <label className="text-[#181E4B] font-medium text-sm md:text-base">
                Password
              </label>
              <a
                href="#"
                className="text-[#DF6951] text-xs md:text-sm hover:underline font-medium"
              >
                Forgot?
              </a>
            </div>
