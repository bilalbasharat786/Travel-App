  ...
  return (
    <footer className="bg-white pt-16 pb-8 px-6 md:px-12 lg:px-24 font-sans">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-5">
            <div className="flex gap-4">
              ...
              <div
                className="w-10 h-10 rounded-full shadow-md flex items-center justify-center text-white cursor-pointer transition"
                style={{
                  background:
                    "linear-gradient(180deg, #B8D2F1 0%, #F28364 100%)",
                }}
              >
            ...
            <h4 className="text-gray-500 font-medium text-lg mt-2">
              Discover our app
            </h4>
